    ...
    <h1>List of Donors
        ...
        if($result->num_rows>0) {
            while($row = $result->fetch_assoc()) {
                ?>
        <div class="donor1" id="geeks" >
            <br>
            <span><li>
     <p class="donor2">DONOR NAME : <?php echo $row["name1"]; ?></p><br><br>
     <p class="donor2">Gender : <?php echo $row["gender"]; ?></p><br>
     <p class="donor2">BLOOD Group : <?php echo $row["blood"]; ?></p><br>
     <p class="donor2">Phone Number : <?php echo $row["phone"]; ?></p><br>
     <p class="donor2">City : <?php echo $row["city"]; ?></p><br>
     </span></li>
</div>
<?php   }
        }
